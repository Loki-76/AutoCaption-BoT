...
try: app_id = int(os.environ.get("app_id", "20763817"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "07186e8f2ffe607e99eedf7eaa5e630b")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7524978204:AAH02gfVXZAaWsTbwBw70bhwRkRps7yPwCM")
...
<b>@moviesandwebserieshubOrzz</b>"""

about_message = """
<b>• Name : [AutoCaption V1](t.me/{username})</b>
<b>• Developer : [BATMAN](https://t.me/itsstoic)
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/moviesandwebserieshubOrzz>Click Here</a></b>
<b>• Source Code : <a href=https://DesiN3rd>Click Here</a></b>"""
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/moviesandwebserieshubOrzz"),
...
print("Bot Created By https://t.me/Itsstoic")
